...
def PythonDict2Lpc( data, indentFlg=False, indentCnt=0, maxIndentCnt=0):
...
def PythonList2Lpc( data, indentFlg=False, indentCnt=0, maxIndentCnt=0):
	if indentCnt > max_indent_cnt:
		indentFlg = False
...
def PythonTuple2Lpc( data, indentFlg=False, indentCnt=0, maxIndentCnt=0 ):
	return PythonList2Lpc(data, indentFlg, indentCnt, maxIndentCnt)
...
def PythonData2Lpc( data, indentFlg=False, indentCnt=0, maxIndentCnt=0):
	...
	if isinstance(data, str):
		...
		return PythonDict2Lpc( data, indentFlg, indentCnt, maxIndentCnt)
